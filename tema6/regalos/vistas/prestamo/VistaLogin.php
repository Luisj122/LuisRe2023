<img src="../../estilos/estilos/jquery-easing/jquery.easing.min.js" alt="">
<?php
...
class VistaLogin{
    ...
    public static function mostrarLogin(){
      ...
      <body class="bg-gradient-primary">
          ...
          <script src="./estilos/estilos/jquery/jquery.min.js"></script>
          <script src="./estilos/estilos/bootstrap/js/bootstrap.bundle.min.js"></script>
      
          <!-- Core plugin JavaScript-->
          <script src="./estilos/estilos/jquery-easing/jquery.easing.min.js"></script>
