  ...
  public static function render($regalos)
  {
    ...
    echo "<table class='table table-striped '>";
      ...
      echo "<form method='post' action='enrutador.php'>
              <label class='text-dark'>Año:&nbsp&nbsp&nbsp&nbsp </label>
                <input  type='text' name='anio'>
                <input type='hidden' name='accion' value='buscarAnio'>
              <button class='btn btn-sm btn-outline-secondary' type'submit'>Buscar</button>  

              <a  type='button' data-toggle='modal' data-target='#nuevoRegalo' class='btn btn-sm btn-outline-secondary float-sm-right'>
                <span class='material-symbols-outlined'>Nuevo Regalo</span>
              </a>
      ...
      echo "<thead class='text-dark'>";
        ...
        foreach ($regalos as   $value) {
          ...
          echo "<td> <input type='text' name='nombre' value='" . $value->getNombre() . "' /></td>
                <td> <input type='text' name='destinatario' value='" . $value->getDestinatario() . "' /></td>
                <td> <input type='text' name='precio' value='" . $value->getPrecio() . "' /></td>
                <td>
